var VueReactivity = (() => {
  ...
  var targetsMap = /* @__PURE__ */ new WeakMap();
  function track(target, type, key) {
    if (!activeEffect)
      return;
    let depsMap = targetsMap.get(target);
    if (!depsMap) {
      targetsMap.set(target, depsMap = /* @__PURE__ */ new Map());
    }
  ...
  function trigger(target, type, key, vlaue, oldValue) {
